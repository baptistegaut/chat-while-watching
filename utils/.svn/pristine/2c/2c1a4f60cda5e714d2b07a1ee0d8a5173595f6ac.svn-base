...
joinRoomOKONE`.
    ...
    def initCompleteONE(self, userList, movieList):
        ...
        the movie room after this function is called.
         ...
         .. warning::
            movieList must be a list of tuples of strings,
            ...
            If present, the fourth string refers to the identifier of the movie.
            Any subsequent value (fifth and beyond) will be ignored
        ...
        assert all(isinstance(m, (tuple)) and len(m) >= 3  for m in movieList)
